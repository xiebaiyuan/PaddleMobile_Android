...
class GoogleNetModelLoaderCombinedQualifiedImpl : ModelLoader() {


    private var type = ModelType.googlenet_qualified
    ...
    override fun load() {
        ...
        PML.loadCombinedQualified(modelPath, paramsPath)
    }
